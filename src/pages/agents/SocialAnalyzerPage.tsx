...
- Analyze from any platform (Instagram, Twitter/X, TikTok, Facebook, YouTube)
- Provide engagement metrics and insights
- Suggest content strategies
- Compare accounts and track trends
Use web search to gather public information.
Present findings in structured format with actionable insights.
        ...
        {!hasMessages && (
          <div className="flex flex-col items-center justify-center h-full">
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-sm space-y-5 w-full">
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto"><BarChart3 className="w-8 h-8 text-primary" /></div>
              <h2 className="text-lg font-bold text-foreground">Social Analyzer</h2>
              <p className="text-sm text-muted-foreground">Paste a social media profile or post URL for analysis</p>
