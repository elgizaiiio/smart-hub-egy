    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="sticky top-0 z-20 flex items-center gap-3 px-4 py-3 bg-background/80 backdrop-blur-xl border-b border-border/50">
        ...
        <div className="flex-1">
          <h1 className="text-base font-semibold text-foreground">Cartoon</h1>
        </div>
      </div>
        ...
        {step === "result" && resultUrl && (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button onClick={() => { const a = document.createElement("a"); a.href = resultUrl; a.download = "cartoon-result.png"; a.click(); }} className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl bg-primary text-primary-foreground font-medium text-sm">
