    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="sticky top-0 z-20 flex items-center gap-3 px-4 py-3 bg-background/80 backdrop-blur-xl border-b border-border/50">
        ...
        <div className="flex-1">
          <h1 className="text-base font-semibold text-foreground">Hair Changer</h1>
        </div>
      </div>
      ...
      <div className="flex-1 px-4 py-4 overflow-y-auto pb-32">
        ...
        {step === "templates" && (
          <div className="space-y-4">
            ...
            {templates.length > 0 ? (
              <TemplateGrid templates={templates} onSelect={handleTemplateSelect} onCustom={() => {}} customLabel="Custom Hairstyle" />
            ) : (
              <p className="text-center text-muted-foreground text-sm py-8">No templates available yet</p>
            )}
          </div>
        )}
