...
const OutlookIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none">
    <path d="M24 7.387v10.478c0 .23-.08.424-.238.576a.806.806 0 0 1-.588.234h-8.55v-6.96l1.26.96a.39.39 0 0 0 .252.084.39.39 0 0 0 .252-.084l.012-.012a.34.34 0 0 0 .12-.264V11.34a.39.39 0 0 0-.156-.312l-.012-.012a.33.33 0 0 0-.204-.072.39.39 0 0 0-.228.072l-1.296.984V10.8h8.55c.234 0 .426.078.588.234A.777.777 0 0 1 24 11.61v-4.223z" fill="#0364B8"/>
    <path d="M16.92 10.8v1.2l-1.296.984a.39.39 0 0 1-.228.072.33.33 0 0 1-.204-.072l-.012-.012a.39.39 0 0 1-.156-.312V11.34a.34.34 0 0 1 .12-.264l.012-.012a.39.39 0 0 1 .252-.084.39.39 0 0 1 .252.084l1.26.96V10.8z" fill="#0A2767"/>
    <path d="M24 7.387l-4.674 3.413-4.702-3.413V5.82c0-.234.078-.432.234-.594a.806.806 0 0 1 .588-.234h8.55l.004 2.395z" fill="#28A8EA"/>
    <path d="M14.624 18.675V5.82a.81.81 0 0 1 .24-.594.806.806 0 0 1 .588-.234H9.6v14.25c0 .54.186 1.002.558 1.386A1.86 1.86 0 0 0 11.52 21.6h7.068a.806.806 0 0 0 .588-.234.777.777 0 0 0 .234-.576v-.168a6.348 6.348 0 0 1-2.622-.57 6.606 6.606 0 0 1-2.164-1.377z" fill="#0078D4"/>
    <path d="M9.6 5.4v14.4c0 .54.186 1.002.558 1.386A1.86 1.86 0 0 0 11.52 22.2h7.656a.806.806 0 0 0 .588-.234.777.777 0 0 0 .234-.576V7.387L14.624 4.8H11.52c-.54 0-1.002.192-1.362.558A1.862 1.862 0 0 0 9.6 6.72v-1.32z" fill="#0364B8" fillOpacity=".5"/>
    <rect x="0" y="5.4" width="10.8" height="13.2" rx="1.2" fill="#0078D4"/>
    <path d="M5.4 9.6c-1.98 0-3.3 1.56-3.3 3.36 0 1.8 1.32 3.36 3.3 3.36s3.3-1.56 3.3-3.36c0-1.8-1.32-3.36-3.3-3.36zm0 5.4c-1.08 0-1.86-.84-1.86-2.04 0-1.2.78-2.04 1.86-2.04s1.86.84 1.86 2.04c0 1.2-.78 2.04-1.86 2.04z" fill="white"/>
  </svg>
);
