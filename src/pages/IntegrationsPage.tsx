...
import { ArrowLeft, Check, Loader2, Github, Mail, HardDrive, Calendar, BookOpen, MessageSquare, Database, BarChart3, Youtube, Send, Figma, Users, Video, Camera, Facebook, Linkedin, MessageCircle } from "lucide-react";
...
const integrations = [
  ...
  { id: "gdrive", name: "Google Drive", description: "Upload and manage files", icon: HardDrive, category: "Storage", app: "googledrive" },
  { id: "gcalendar", name: "Google Calendar", description: "Create events & manage schedule", icon: Calendar, category: "Productivity", app: "googlecalendar" },
  { id: "notion", name: "Notion", description: "Create pages & manage workspace", icon: BookOpen, category: "Productivity", app: "notion" },
  { id: "slack", name: "Slack", description: "Send messages to channels", icon: MessageSquare, category: "Communication", app: "slack" },
  { id: "supabase", name: "Supabase", description: "Backend & database management", icon: Database, category: "Development", app: "supabase" },
  { id: "hubspot", name: "HubSpot", description: "CRM & marketing automation", icon: BarChart3, category: "Business", app: "hubspot" },
  { id: "youtube", name: "YouTube", description: "Search & manage video content", icon: Youtube, category: "Social", app: "youtube" },
  { id: "outlook", name: "Outlook", description: "Email & calendar management", icon: Send, category: "Communication", app: "outlook" },
  ...
  { id: "discord", name: "Discord", description: "Send messages & manage servers", icon: MessageCircle, category: "Communication", app: "discord" },
];
